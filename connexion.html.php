...
<div id="container">
    <div class="lf">
            ...
            <h3 style="margin: 3%;">X</h3>
             ...
             <form action="<?=WEBROOT ?>" method="POST" class="form">
                ...
                <?php endif ?>
                <div class="foo">
                <input type="submit" id='submit1' name='connexion' value='connexion' class="submit">
...
<?php unset($_SESSION['errors']);?>
        <script src="<?=PATH_PUBLIC."js".DIRECTORY_SEPARATOR."connexion.script.js"?>"></script>
</body>
</html>
